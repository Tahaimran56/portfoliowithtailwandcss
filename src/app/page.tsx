...
export default function Home() {
  return (
    <div className="max-w-4xl mx-auto p-8 font-sans bg-gray-500 text-center">
      ...
      <section className="my-10 p-8 bg-gray-200 text-center">
        <h1 className="text-3xl font-bold mb-4 italic text-gray-800">Welcome to My Portfolio</h1>
        ...
        <p className="text-lg">
          ...
          <i>including </i> <strong>TypeScript , React, Next, Tailwind CSS, and more!&quot; </strong>
          </b>
        </p>
